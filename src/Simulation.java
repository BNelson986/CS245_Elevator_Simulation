...
public class Simulation {
    ...
    public void startSim () {
        ...
        //  UNCOMMENT TO SEE SPECIFIED DURATION OF SIMULATION
        /*
        ...
        while (ticksLeft-- > 0) {
            ...
            for (int f = 0; f < getFloors(); f++) {
                ...
                if (chanceOfGeneration < getPassengers()) {
                    ...
                    //  Generate new destination until it is different from start
                    while (f == destFloor) {
            ...
            /*
                ...
                for(Simulation.Passenger passenger : elevator.get(i).passengers){
                    if(passenger.direction() != elevator.get(i).getDirection() &&
                        ...
                        System.out.println("Simulation.Passenger: " + passenger +
                                " Start Floor: " + passenger.startFloor +
                ...
                //  Check for elevator within designated floors
        ...
        if (elevDirection == 'U') {
            while (currFloor < getFloors() && elevMove++ < 5) {
                ...
                if (elevator.get(i).atDestination(currFloor)) {
                    //  Don't move if on the same floor
                    if (elevMove > 0) {
     ...
     * them to the elevator. Simulation.Passenger will not board
    ...
    private class Elevator {
        ...
        //  Simple functions for operation of elevator
